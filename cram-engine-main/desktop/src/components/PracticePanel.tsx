...
export default function PracticePanel({ questions, activeProjectId, onQuestionsUpdated, onStatus, onNavigateToImport }: Props) {
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          {currentQuestion ? (
            ...
            <div className="empty-practice">
              ...
              {mode !== 'wrong' && (
                <button className="primary" onClick={() => { onNavigateToImport?.(); onStatus('已切换到题目录入页'); }}>
                  去录入题目
                </button>
              )}
            </div>
